  ...
  const instructorItems = [
    {
      ...
      items: [
        ...
        {
          name: "Message",
          path: "/instructor/instructor-message",
          tag: 12,
          icon: (
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        },
        {
          ...
          path: "/instructor/instructor-my-quiz-attempts",
          icon: (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
        ...
        {
          name: "Order History",
          path: "/instructor/instructor-order-history",
          icon: (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: "Announcments",
          path: "/instructor/instructor-announcments",
          icon: (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
        ...
        {
          name: "Assignments",
          path: "/instructor/instructor-assignments",
          icon: (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
