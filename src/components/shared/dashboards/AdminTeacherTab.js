...
import AdminTeacherCreate from "./AdminTeacherCreate";

const AdminTeacherTab = () => {
  const { currentIdx, handleTabClick } = useTab();
  const tabbuttons = [
    {
      name: "Teacher List",
      content: <AdminTeacherList />,
    },
    {
      name: "Teacher Create",
      content: <AdminTeacherCreate />,
    },
  ];
  return (
...
export default AdminTeacherTab;
